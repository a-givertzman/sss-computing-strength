...
impl Displacement {
    ...
    fn area(&self, pos_x: f64, draft: f64) -> f64 {
        ...
        if frames_first.shift_x() >= pos_x {
            log::info!("\t Displacement area pos_x:{pos_x} draft:{draft}  frames_first.shift_x() {} >= pos_x",  frames_first.shift_x());      
        ...
        if frames_last.shift_x() <= pos_x {
            log::info!("\t Displacement area pos_x:{pos_x} draft:{draft}  frames_last.shift_x() {} <= pos_x",  frames_last.shift_x());  
