...
///
impl std::fmt::Display for HorizontalAreaData {
...
///
pub type HorizontalAreaDataArray = DataArray<HorizontalAreaData>;
///
impl HorizontalAreaDataArray {
    /// Преобразование данных в массив
    pub fn data(self) -> Vec<HorizontalAreaData> {
        self.data
    }  
}
/// Площадь обледенения
