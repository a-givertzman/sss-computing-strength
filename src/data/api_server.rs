...
pub fn get_data(
    ...
    //    dbg!(&h_subdivision);
    log::trace!("input_api_server h_subdivision read ok");
    ...
    log::trace!("input_api_server area_h_str read ok");
    ...
    log::trace!("input_api_server area_h_stab read ok");
    ...
    log::trace!("input_api_server area_v_str read ok");
